    ...
    if album_data:
        ...
        if result == "":
            if album.add(album_data):
                ...
                err_message = "\n*******************************************************************************************************\n   АЛЬБОМ НЕ СОХРАНЕН! {} УЖЕ ЕСТЬ В БАЗЕ ДАННЫХ! Код ошибки: 409\n*******************************************************************************************************\n".format(album_data["album"].title())
